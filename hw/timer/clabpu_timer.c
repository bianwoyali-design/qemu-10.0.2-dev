...
static const VMStateDescription vmstate_clabpu_timer = {
    ...
    .fields =
        (const VMStateField[]){ VMSTATE_UINT32(counter, CLabPUTimerState),
...
static const TypeInfo clabpu_timer_info = { .name = TYPE_CLABPU_TIMER,
                                            .parent = TYPE_SYS_BUS_DEVICE,
                                            .instance_size =
                                                sizeof(CLabPUTimerState),
                                            .class_init =
                                                clabpu_timer_class_init };
