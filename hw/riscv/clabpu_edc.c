...
static const MemoryRegionOps clabpu_edc_err_ops = {
    .read = clabpu_edc_err_read,
...
static void clabpu_edc_init(Object *obj)
{
    ...
    memory_region_add_subregion(system_memory, CLABPU_EDC_ERR_BASE, &s->err);
...
static const VMStateDescription vmstate_clabpu_edc = {
    ...
    .fields =
        (const VMStateField[]){ VMSTATE_UINT32(ctrl, CLabPUEdcState),
